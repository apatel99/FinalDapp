...
class CreateInstitute extends React.Component
{
    ...
    handlesubmit= async(e)=>
    {
       ...
       addr=await ethereum.enable()
        ...
        await contract.NewStudent(addr.toString())
        ...
        return(
            <div className="section">
             <form onSubmit={this.handlesubmit}>  
                <input  type="text"  name="Name" placeholder="Enter Institute Name"  label="Name" onChange={this.handlechange} value={this.state.Name}/>
            ...
            <div className="sub section">
                <form onSubmit={this.handlesubmit1} >
                    <h2>Check your Institute ID</h2>
                    <input placeholder="Enter Name" type="text" name="Name1" onChange={this.handlechange} value={this.state.Name1} />
                    <br/>
                    <button type="submit" className="create-btn" disabled={loading2} >
